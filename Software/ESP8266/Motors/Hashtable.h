// Got from Github:
// https://github.com/braydenanderson2014/C-Arduino-Libraries/blob/main/lib/Hashtable/README.md
// The library has a couple of bugs I fixed (it was missing a line about getting the index)
